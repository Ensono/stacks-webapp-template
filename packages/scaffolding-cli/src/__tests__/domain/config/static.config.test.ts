...
const currentSupportedPaths = ["ssr", "csr", "netcore", "javaSpring", "javaSpringKarate", "javaSpringCqrs", "javaSpringCqrsKarate", "javaSpringJenkins", "netcoreSelenium",
...
describe("StaticConfig tests", () => {
    ...
    it("staticConf return an object with only specified keys", () => {
        expect(confKeys.length).toBe(17)
