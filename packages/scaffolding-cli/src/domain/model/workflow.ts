...
export function WorkflowOptions(): Workflow {
    return {
        ...
        test_netcore_selenium_any_azdevops: FlowSelector.option_netcore_selenium_aks_azdevops,
        test_js_testcafe_any_azdevops: FlowSelector.option_js_testcafe_aks_azdevops,
