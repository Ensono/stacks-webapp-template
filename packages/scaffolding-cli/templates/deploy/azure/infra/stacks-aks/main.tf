...
module "aks_bootstrap" {
  source                  = "git::https://github.com/amido/stacks-terraform-azurerm//aks?ref=v1.0.0"
...
module "ssl_app_gateway" {
  source                  = "git::https://github.com/amido/stacks-terraform-azurerm//app-gateway?ref=v1.0.0"
  resource_namer            = "${module.default_label.id}"
