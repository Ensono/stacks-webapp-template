...
module "aks_bootstrap" {
  source                  = "git::https://github.com/amido/stacks-webapp-template//libs/orchestration/terraform-azurerm-amido-aks?ref=task/1684-part2"
...
module "ssl_app_gateway" {
  source                  = "git::https://github.com/amido/stacks-webapp-template//libs/orchestration/terraform-azurerm-amido-ssl-app-gateway?ref=task/1684-part2"
  resource_namer            = "${module.default_label.id}"
